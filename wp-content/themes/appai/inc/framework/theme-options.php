     ...
     Redux::setSection( $opt_name, array(
         ...
         'fields'           => array(
            ...
            array(
                ...
                'type'     => 'color_gradient',
                'title'    => esc_html__( 'Preloader Background', 'appai' ),
                'subtitle' => esc_html__( 'Select the preloader background color', 'appai' ),
     ...
     Redux::setSection( $opt_name, array(
         ...
         'fields'           => array(
             ...
             array(
                 ...
                 'output'      => array('header.custom .navbar.affix-top'),
                 'units'       =>'px',
                 'required'   => array( 'menu_scheme', 'equals', 'custom' ),
             ...
             array(
                 ...
                 'output'      => array('header.custom .navbar.affix-top .navbar-nav li a'),
                 'units'       =>'px',
                 'required'   => array( 'menu_scheme', 'equals', 'custom' ),
             ),
             ...
             array(
                 ...
                 'output'      => array('header.custom .navbar.affix-top .navbar-nav li a:hover'),
                 'units'       =>'px',
                 'required'   => array( 'menu_scheme', 'equals', 'custom' ),
             ),
             ...
             array(
                 'id'          => 'menu_item_dropdown_border_color',
                 'type'        => 'color',
                 'title'       => esc_html__('Dropdown Border Color', 'appai'),
                 'units'       =>'px',
                 'required'   => array( 'menu_scheme', 'equals', 'custom' ),
             ),
             ...
             array(
                 ...
                 'output'      => array('header.custom .navbar.affix-top .navbar-nav li .sub-menu li a'),
                 'units'       =>'px',
                 'required'   => array( 'menu_scheme', 'equals', 'custom' ),
             ),
             ...
             array(
                 ...
                 'output'      => array('header.custom .navbar.affix-top .navbar-nav li .sub-menu li a:hover'),
                 'units'       =>'px',
                 'required'   => array( 'menu_scheme', 'equals', 'custom' ),
             ),

             array(
                 'id'          => 'menu_item_dropdown_hover_bg_color',
                 'type'        => 'color',
                 'title'       => esc_html__('Dropdown Menu Item Hover Background Color', 'appai'),
                 'units'       =>'px',
                 'required'   => array( 'menu_scheme', 'equals', 'custom' ),
             ),
             ...
             array(
                 ...
                 'type'        => 'color_gradient',
                 'title'       => esc_html__('Navbar Background', 'appai'),
                 'output'      => array('header.custom .navbar.affix'),
                 'units'       =>'px',
                 'required'   => array( 'menu_scheme', 'equals', 'custom' ),
                 'subtitle'    => esc_html__('Set your preferred gradient backgrond  for Navigation.', 'appai'),
                 'default'  => array(
              ...
              array(
                  ...
                  'type'        => 'color',
                  'title'       => esc_html__('Menu Item Color', 'appai'),
                  'output'      => array('header.custom .navbar.affix .navbar-nav li a'),
                  'units'       =>'px',
                  'required'   => array( 'menu_scheme', 'equals', 'custom' ),
              ),
              ...
              array(
                  ...
                  'type'        => 'color',
                  'title'       => esc_html__('Menu Item Hover Color', 'appai'),
                  'output'      => array('header.custom .navbar.affix .navbar-nav li a:hover'),
                  'units'       =>'px',
                  'required'   => array( 'menu_scheme', 'equals', 'custom' ),
              ),
              ...
              array(
                  'id'          => 'after_scroll_menu_item_dropdown_border_color',
                  'type'        => 'color',
                  'title'       => esc_html__('Dropdown Border Color', 'appai'),
                  'units'       =>'px',
                  'required'   => array( 'menu_scheme', 'equals', 'custom' ),
              ...
              array(
                  ...
                  'type'        => 'color',
                  'title'       => esc_html__('Dropdown Menu Item Color', 'appai'),
                  'output'      => array('header.custom .navbar.affix .navbar-nav li .sub-menu li a'),
                  'units'       =>'px',
                  'required'   => array( 'menu_scheme', 'equals', 'custom' ),
              ),
              ...
              array(
                  ...
                  'type'        => 'color',
                  'title'       => esc_html__('Dropdown Menu Item Hover Font Color', 'appai'),
                  'output'      => array('header.custom .navbar.affix .navbar-nav li .sub-menu li a:hover'),
                  'units'       =>'px',
                  'required'   => array( 'menu_scheme', 'equals', 'custom' ),
              ),

              array(
                  'id'          => 'after_scroll_menu_item_dropdown_hover_bg_color',
                  'type'        => 'color',
                  'title'       => esc_html__('Dropdown Menu Item Hover Background Color', 'appai'),
                  'units'       =>'px',
                  'required'   => array( 'menu_scheme', 'equals', 'custom' ),
     ...
     Redux::setSection( $opt_name, array(
         ...
         'fields'           => array(
            array(
                'id'       => 'accent_color',
                'type'     => 'color',
                'title'    => esc_html__( 'Accent Color', 'appai' ),
                'subtitle' => esc_html__( 'Choose site accent color.', 'appai' ),
                'output'  => array(
                    'color' => '.post-title a:hover, .post-content .read-more-btn:hover, table tfoot tr td#prev a:hover, table tfoot tr td#next a:hover, .blog_area .post_content a, .blog_area table tr td a, .widget ul li a:hover, .widget_search button#searchsubmit, body.search-no-results .m-blog-posts-listing .appai-search-form button#searchsubmit, .prev-next-posts .inner-col a:hover, .prev-next-posts .inner-col i:hover, .breadcrumbs span, table tfoot tr td#prev a, table tfoot tr td#next a, .read-more-btn:hover i, .comming-soon-wrapper .social a',
                    'border-color' => '.pagination .page-numbers.current, .pagination a:hover, .cdown span',
                    'background-color' => '.pagination .page-numbers.current, .pagination a:hover, .cdown p'
                ),
                'default'  => true
            ),
            array(
                'id'       => 'accent_gradient',
                'type'     => 'color_gradient',
                'title'    => esc_html__( 'Accent Gradient', 'appai' ),
                'subtitle' => esc_html__( 'Choose site accent gredient color.', 'appai' ),
                'default'  => array(
                    'from' => '#00c9fd',
                    'to'   => '#81ee8e',
                ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            array(
                ...
                'desc'    => __( 'Use <b>"dynamic_title"</b> to show post title dynamically or enter any title text for single article page.', 'appai' ),
